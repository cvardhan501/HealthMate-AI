...
const medicineDB = [
  {
    keywords: ["eye pain", "eyes hurting", "dry eyes", "red eyes", "itchy eyes", "eye burning", "watery eyes"],
    category: "Eye Problems",
    medicines: [
      {
        name: "Lubricating eye drops",
      ...
      },
      {
        ...
        use: "May help allergic itchy/red eyes",
        type: "Pharmacist advice",
        warning: "Consult eye doctor if pain, vision change, or severe redness."
      }
    ],
    homeCare: ["Avoid rubbing eyes", "Reduce screen time", "Use cold compress", "Wash eyes with clean water"],
    recovery: "Mild irritation may improve in 1–2 days."
  },
  {
    keywords: ["stomach pain", "abdominal pain", "stomach ache", "stomach cramps", "tummy pain"],
    category: "Stomach Pain",
    medicines: [
      {
        name: "Antacid",
    ...
    homeCare: ["Eat light food", "Avoid spicy/oily food", "Drink warm water", "Rest"],
    recovery: "Mild stomach pain may improve within 1–2 days."
  },
  {
    keywords: ["fever", "temperature", "body heat", "feverish", "headache", "body pain"],
    category: "Pain, Fever, and Inflammation",
    medicines: [
      {
        name: "Paracetamol / Acetaminophen",
        brands: "Dolo 650, Calpol, Crocin, Tylenol",
      ...
      },
      {
        ...
        use: "Used for fever, inflammation, and body aches",
        type: "OTC / Pharmacist advice",
        warning: "Avoid in stomach ulcer, kidney disease, asthma sensitivity, pregnancy, or elderly risk."
      }
    ],
    homeCare: ["Drink enough water", "Take rest", "Monitor temperature", "Avoid heavy activity"],
    recovery: "Mild fever/pain usually improves in 2–3 days."
  },
  {
    keywords: ["cold", "sneezing", "runny nose", "blocked nose", "nose block", "allergy", "hay fever"],
    category: "Cold and Allergy",
    medicines: [
      {
        name: "Cetirizine",
      ...
      },
      {
        ...
        use: "Used for cold, headache, blocked nose",
        type: "Pharmacist advice",
        warning: "May contain paracetamol. Avoid in BP/heart conditions."
      }
    ],
    homeCare: ["Steam inhalation", "Drink warm fluids", "Rest well", "Avoid cold drinks"],
    recovery: "Common cold usually improves in 3–7 days."
  },
  {
    keywords: ["cough", "dry cough", "wet cough", "throat irritation", "sore throat", "throat pain"],
    category: "Cough and Throat",
    medicines: [
      {
        name: "Cough syrup / Lozenges",
        ...
        use: "May help cough or throat irritation",
        type: "OTC / Pharmacist advice",
        warning: "Some cough syrups cause sleepiness. Avoid self-use in small children."
      }
    ],
    homeCare: ["Warm salt water gargle", "Drink warm fluids", "Avoid smoke and dust"],
    recovery: "Mild cough/throat irritation may improve in 3–7 days."
  },
  {
    keywords: ["ear pain", "ear ache", "earache", "ear block", "ear wax", "ear itching"],
    category: "Ear Problems",
    medicines: [
      {
        name: "Paracetamol",
      ...
      },
      {
        ...
        use: "May help ear wax blockage",
        type: "Pharmacist advice",
        warning: "Do not use if ear discharge, injury, or severe pain."
      }
    ],
    homeCare: ["Do not insert earbuds deeply", "Keep ear dry", "Use warm compress externally"],
    recovery: "Mild ear discomfort may improve in 1–3 days."
  },
  {
    keywords: ["tooth pain", "toothache", "gum pain", "dental pain", "mouth pain"],
    category: "Dental Problems",
    medicines: [
      {
        name: "Paracetamol",
    ...
    homeCare: ["Warm salt water rinse", "Avoid very hot/cold foods", "Maintain oral hygiene"],
    recovery: "Pain relief may be temporary; dental cause needs dentist."
  },
  {
    keywords: ["skin rash", "rash", "itching", "skin allergy", "hives"],
    ...
    medicines: [
      {
        ...
        use: "May help itching/allergy symptoms",
        type: "OTC / Pharmacist advice",
        warning: "Seek urgent help if swelling of lips/face or breathing difficulty."
      },
      {
        name: "Calamine lotion",
        brands: "Caladryl, Calamine",
    ...
    homeCare: ["Avoid scratching", "Use cool compress", "Avoid suspected allergen"],
    recovery: "Mild allergy/rash may improve in 1–3 days."
  },
  {
    keywords: ["acidity", "gas", "heartburn", "acid reflux", "gerd", "stomach burning"],
    category: "Stomach and Digestion",
    medicines: [
      {
        name: "Antacid",
    ...
    homeCare: ["Avoid spicy food", "Eat smaller meals", "Do not lie down immediately after food"],
    recovery: "Mild acidity may improve within 1–2 days."
  },
  {
    keywords: ["loose motion", "diarrhea", "vomiting", "dehydration", "stomach upset"],
    category: "Diarrhea and Dehydration",
    medicines: [
      {
        name: "ORS",
      ...
      },
      {
        ...
        use: "Used for diarrhea relief",
        type: "Pharmacist/doctor advice",
        warning: "Avoid if fever or blood in stool. Do not self-use in children."
      }
    ],
    homeCare: ["Drink ORS", "Eat light food", "Avoid oily food", "Rest"],
    recovery: "Mild diarrhea may improve in 1–3 days."
...
function normalizeSymptoms(input) {
  ...
  if (text.includes("eye") || text.includes("eyes")) {
    if (text.includes("pain") || text.includes("hurting")) keywords.push("eye pain");
    if (text.includes("red")) keywords.push("red eyes");
    if (text.includes("itch")) keywords.push("itchy eyes");
    if (text.includes("dry") || text.includes("laptop") || text.includes("screen")) keywords.push("dry eyes");
  }

  if (text.includes("fever") || text.includes("temperature")) keywords.push("fever");
  if (text.includes("cold") || text.includes("sneezing") || text.includes("runny nose")) keywords.push("cold");
  if (text.includes("headache") || text.includes("head pain")) keywords.push("headache");
  if (text.includes("stomach") || text.includes("tummy")) keywords.push("stomach pain");
  if (text.includes("tooth") || text.includes("dental")) keywords.push("tooth pain");
  if (text.includes("ear")) keywords.push("ear pain");
  if (text.includes("rash") || text.includes("itching")) keywords.push("skin rash");
...
function getAgeWarning(age) {
  ...
  if (!age) return "Age not provided. Medicine safety depends on age.";
  if (numAge < 2) return "Age below 2 years: do not give medicines without pediatric doctor advice.";
  if (numAge < 12) return "Child age: avoid self-medication. Dose and medicine must be confirmed by pediatrician/pharmacist.";
  if (numAge >= 60) return "Elderly age: higher risk of side effects. Consult doctor/pharmacist before medicines.";
...
function filterMedicinesBySafety(medicines, age, allergies, conditions) {
  ...
  return medicines.filter(med => {
    const combined = `${med.name} ${med.brands}`.toLowerCase();

    if (allergyText && combined.includes(allergyText)) return false;
    if (allergyText.includes("paracetamol") && combined.includes("paracetamol")) return false;
    if (allergyText.includes("dolo") && combined.includes("dolo")) return false;
    if (allergyText.includes("crocin") && combined.includes("crocin")) return false;
    if (allergyText.includes("ibuprofen") && combined.includes("ibuprofen")) return false;
    if (allergyText.includes("cetirizine") && combined.includes("cetirizine")) return false;
    if (allergyText.includes("sinarest") && combined.includes("sinarest")) return false;

    if (conditionText.includes("liver") && combined.includes("paracetamol")) return false;
    if (conditionText.includes("kidney") && combined.includes("ibuprofen")) return false;
    if (conditionText.includes("ulcer") && combined.includes("ibuprofen")) return false;
    if (conditionText.includes("asthma") && combined.includes("ibuprofen")) return false;
    if (conditionText.includes("bp") && combined.includes("sinarest")) return false;
    if (conditionText.includes("blood pressure") && combined.includes("sinarest")) return false;
    if (conditionText.includes("pregnancy")) return false;
...
function detectSeverity(symptoms, age) {
  ...
  if (text.includes("body pain")) score += 1;
  if (text.includes("loose motion") || text.includes("diarrhea")) score += 1;
  if (text.includes("eye pain") || text.includes("ear pain") || text.includes("tooth pain")) score += 1;
...
app.post("/healthmate", (req, res) => {
  ...
  let medicines = removeDuplicates(matches.flatMap(item => item.medicines), "name");
  medicines = filterMedicinesBySafety(medicines, age, allergies, conditions);
    ...
    medicines = [
      {
        ...
        use: "Please consult a doctor/pharmacist",
        type: "Doctor/pharmacist advice",
        warning: "Your entered age, allergy, or condition may make common medicines unsafe."
      }
    ];
  }
